...
import { DiGoogleCloudPlatform, DiJqueryLogo } from "react-icons/di";
    ...
    <div className="modal-container">
      ...
      >
          ...
          <div className="content">
            ...
            <div className="description-container">
              ...
              <p>
                ...
                contact sellers for permission to purchase and download uploads.
              </p>
          ...
          <div className="content">
            ...
            <div className="description-container">
              ...
              <p>
                ...
                <br />
                <br />
                This app sends you SMS and email notifications using Notivize, a
                notification API, and alerts you whenever the number of COVID-19
                cases increases or decreases in your area.
                <br />
                <br />
                All you have to do is enter your contact information.
                <br />
                <br />
                Our project won an honor award for best use of Notivize's API in
                March, 2021.
              </p>
        ...
        {modalType === "item3" && (
          <div className="content">
            ...
            <div className="description-container">
              ...
              <p>
                Created the front-end of a phone trade-in application during my
                Software internship at B-Stock Solutions alongside summer
        ...
        {modalType === "item4" && (
          <div className="content">
            <div className="image-container">
              <Image className="image" src={wavyboy} alt="wavyboy pic"></Image>
            </div>
            <div className="description-container">
              ...
              <p>
                ...
                understanding of how a synthesizer works, I decided to build one
                myself with the Tone.js framework.
                <br />
                <br />
          ...
          <div className="content">
            ...
            <div className="description-container">
              ...
              <p>
                ...
                delete, and clear all new tasks using JSON, saving them in cache
          ...
          <div className="content">
            ...
            <div className="description-container">
              ...
              <p>
                ...
                <br />
                <br /> vocals and music production are done with Logic Pro X and
                yours truly.
              </p>
