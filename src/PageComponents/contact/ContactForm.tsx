      ...
      <div className="content-wrapper">
        <div className="image-container">
          <Image
            ...
            width={200}
            placeholder="blur"
            blurDataURL="data:image/webp;base64,"
          ></Image>
